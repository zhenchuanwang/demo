    ...
    <page>
        ...
        <template slot="secondHeader">
            ...
            >
                ...
                >
                    <el-input
                        v-model="queryFormModel.appName"
                        placeholder="请输入应用名称"
                    />
                </el-form-item>
                <el-form-item>
        ...
        >
            ...
            >
                ...
                >
                    <el-input
                        v-model="addDialog.formModel.appName"
                        auto-complete="off"
                    />
                </el-form-item>
                <el-form-item
...
export default {
    ...
    methods: {
        ...
        getListData(queryData) {
            return this.$api.Rs.App.data(queryData).then(json => {
                const res = json.data;
        ...
        onTableEdit(row) {
            const { formModel } = this.addDialog;
            this.$api.Rs.App.getDetail({ id: row.id }).then(json => {
        ...
        onTableDelete(ids) {
            this.$confirm('是否确定要删除！', '温馨提示', {
                ...
                this.$api.Rs.App.delete({ ids }).then(json => {
                    const res = json.data;
                    this.$message({
                        message: res.msg,
                        type: 'success',
